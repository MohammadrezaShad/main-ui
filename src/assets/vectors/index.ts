...
export {default as IconHome2} from './icon-homw-2.svg';
...
export {default as IconProduct} from './icon-product.svg';
...
export {default as IconTickCircle} from './icon-tick-circle.svg';
